...
class BlogTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $blog_description = '<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni.</p>
        ...
        if (!$is_exist->count()) {
            ...
            $blog->blog_image = 'blogs/blog_1.jpeg';
            $blog->is_active = 1;
            $blog->created_at = '2019-01-16 11:16:11';
            $blog->save();
        }
    }
}
